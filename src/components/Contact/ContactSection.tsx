...
export default function ContactSection() {
  ...
  const emailContact = contactData.find(contact => contact.name === 'Email');

  const mailtoUrl = 'mailto:' + emailContact?.url;

  return (
    <>
      <section className="max-w-full w-full px-4 lg:px-24 py-18 lg:py-16" id="contactSection">
        <div className="flex flex-col items-center">
          <p className="font-bold h-full text-4xl lg:text-6xl drop-shadow-md mb-12">Get In Touch</p>
          <p className="w-full lg:w-4/6 text-center">
            I'm actively seeking new opportunities! Whether you have an exciting prospect or simply want to
            connect, feel free to reach out. My inbox is always open and I'm eager to explore potential
            collaborations.
          </p>
          <a
